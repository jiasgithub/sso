...
public class SysService implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8157545645522422503L;
	...
	@OneToMany
	@JoinTable(name = "sys_service_permission", joinColumns = {
			@JoinColumn(name = "service_id") }, inverseJoinColumns = { @JoinColumn(name = "permission_id") })
